...
A scene can be preloaded by calling [Scene.Preload()](../api/AdvancedSceneManager.Models.Scene.html#AdvancedSceneManager_Models_Scene_Preload) or by using the [Scene helper](../api/AdvancedSceneManager.Utility.ASM.html).

A preloaded scene is represented by [PreloadedSceneHelper](../api/dvancedSceneManager.Utility.PreloadedSceneHelper.html), which will be returned by [Scene.Preload()](../api/AdvancedSceneManager.Models.Scene.html#AdvancedSceneManager_Models_Scene_Preload).
