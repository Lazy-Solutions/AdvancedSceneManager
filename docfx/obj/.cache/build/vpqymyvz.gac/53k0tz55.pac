...
<html>
  ...
  <head>
   ...
   | Advanced Scene Manager </title>
    <meta name="title" content="GuidReference
    ...
    <div id="wrapper">
      ...
      <div role="main" class="container body-content hide-when-search">
        ...
        <div class="article row grid-right">
          <div class="col-md-10">
            <article class="content wrap" id="_content" data-uid="AdvancedSceneManager.Utility.GuidReference">
  
  
  <h1 id="AdvancedSceneManager_Utility_GuidReference" data-uid="AdvancedSceneManager.Utility.GuidReference" class="text-break">GuidReference
  </h1>
  ...
  <div class="inheritance">
    ...
    <div class="level5"><span class="xref">GuidReference</span></div>
  </div>
  <h3 id="fields">Fields
  </h3>
  <h4 id="AdvancedSceneManager_Utility_GuidReference_guid" data-uid="AdvancedSceneManager.Utility.GuidReference.guid">guid</h4>
  <div class="markdown level1 summary"></div>
  <div class="markdown level1 conceptual"></div>
  <div class="codewrapper">
    <pre><code class="lang-csharp hljs">public string guid</code></pre>
  </div>
