...
Custom actions has to inherit from SceneAction and can be added to a [SceneOperation](SceneOperation.md) through [SceneOperation.WithAction(SceneAction)](../api/SceneOperation.html#methods).
