...
The standalone scene manager manages scenes that are opened outside of a [collection](SceneCollection.md). For example a pause screen or persistent scenes.
