...
> Note if a custom splash screen is not showing up, you may have to modify the scene and save it, for the splash screen flag to appear. Flag is sometimes not saved.
