...
Custom loading screens can be created by creating a script that inherits from [AdvancedSceneManager.Callbacks.LoadingScreen](), and overrides the abstract methods.
...
void Update()
{
    //Operation may be null for the first few frames
    if (operation != null)
