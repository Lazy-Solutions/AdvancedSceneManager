...
#### Implements
<a href="M_AdvancedSceneManager_Models_SceneCollection_IMethods_Target_PreloadAdditive">SceneCollection.IMethods_Target.PreloadAdditive(SceneCollection, Boolean)</a>  
