...
A generic base class for loading screens. You probably want to inherit from <a href="T_AdvancedSceneManager_Loading_LoadingScreen.md">LoadingScreen</a> though.
...
<tr>
<td><a href="M_AdvancedSceneManager_Loading_LoadingScreenBase_OnClose.md">OnClose</a></td>
<td>Called when the loading screen is about to close.</td></tr>
<tr>
<td><a href="M_AdvancedSceneManager_Loading_LoadingScreenBase_OnOpen.md">OnOpen</a></td>
...
This will automatically register canvas with <a href="T_AdvancedSceneManager_Utility_CanvasSortOrderUtility.md">CanvasSortOrderUtility</a>, to automatically manage canvas sort order.</p></td></tr>
</table>
