...
<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  Object  →  Component  →  Behaviour  →  MonoBehaviour  →  <a href="T_AdvancedSceneManager_Loading_LoadingScreenBase">LoadingScreenBase</a>  →  SplashScreen</td></tr>
<tr><td><strong>Derived</strong></td><td><a href="T_AdvancedSceneManager_Defaults_SplashASM">AdvancedSceneManager.Defaults.SplashASM</a><br /><a href="T_AdvancedSceneManager_Defaults_SplashFade">AdvancedSceneManager.Defaults.SplashFade</a></td></tr>
</table>



## Remarks
SplashScreen and <a href="T_AdvancedSceneManager_Loading_LoadingScreen">LoadingScreen</a> cannot coexist within the same scene.
...
<tr>
<td><a href="M_AdvancedSceneManager_Loading_SplashScreen_OnClose">OnClose</a></td>
<td>Called when splash scene is about to close.<br />(Overrides <a href="M_AdvancedSceneManager_Loading_LoadingScreenBase_OnClose">LoadingScreenBase.OnClose()</a>)</td></tr>
<tr>
<td><a href="M_AdvancedSceneManager_Loading_SplashScreen_OnOpen">OnOpen</a></td>
<td>Called when splash scene is opened.<br />(Overrides <a href="M_AdvancedSceneManager_Loading_LoadingScreenBase_OnOpen">LoadingScreenBase.OnOpen()</a>)</td></tr>
<tr>
