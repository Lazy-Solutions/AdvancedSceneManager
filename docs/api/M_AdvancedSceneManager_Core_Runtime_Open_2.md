# Open(SceneCollection, Boolean) Method
...
#### Implements
<a href="M_AdvancedSceneManager_DependencyInjection_ISceneManager_Open_2">ISceneManager.Open(SceneCollection, Boolean)</a>  
<a href="M_AdvancedSceneManager_Models_SceneCollection_IMethods_Target_Open">SceneCollection.IMethods_Target.Open(SceneCollection, Boolean)</a>  
