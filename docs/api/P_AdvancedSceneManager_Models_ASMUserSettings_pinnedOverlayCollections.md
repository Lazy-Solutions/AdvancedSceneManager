# pinnedOverlayCollections Property
...
**C#**
``` C#
public IEnumerable<SceneCollection> pinnedOverlayCollections { get; }
```
...
#### Implements
<a href="P_AdvancedSceneManager_DependencyInjection_Editor_IUserSettings_pinnedOverlayCollections.md">IUserSettings.pinnedOverlayCollections</a>  
