...
# EvaluateFinalSceneList(Profile, App.StartupProps) Method
...
#### Parameters
<dl><dt>Â Â <a href="T_AdvancedSceneManager_Models_Profile.md">Profile</a></dt><dd>The profile that would be used to run startup process with.</dd><dt>Â Â <a href="T_AdvancedSceneManager_Core_App_StartupProps.md">App.StartupProps</a></dt><dd>The startup props that would be used to run process with.</dd></dl>
