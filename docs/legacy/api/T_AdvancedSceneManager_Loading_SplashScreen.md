...
<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  â†’  Object  â†’  Component  â†’  Behaviour  â†’  MonoBehaviour  â†’  <a href="T_AdvancedSceneManager_Loading_LoadingScreenBase.md">LoadingScreenBase</a>  â†’  SplashScreen</td></tr>
<tr><td><strong>Derived</strong></td><td><a href="T_AdvancedSceneManager_Defaults_SplashASM.md">AdvancedSceneManager.Defaults.SplashASM</a><br /><a href="T_AdvancedSceneManager_Defaults_SplashFade.md">AdvancedSceneManager.Defaults.SplashFade</a></td></tr>
</table>



## Remarks
SplashScreen and <a href="T_AdvancedSceneManager_Loading_LoadingScreen.md">LoadingScreen</a> cannot coexist within the same scene.
...
<tr>
<td><a href="M_AdvancedSceneManager_Loading_SplashScreen_OnClose.md">OnClose</a></td>
<td>Called when splash scene is about to close.<br />(Overrides <a href="M_AdvancedSceneManager_Loading_LoadingScreenBase_OnClose.md">LoadingScreenBase.OnClose()</a>)</td></tr>
<tr>
<td><a href="M_AdvancedSceneManager_Loading_SplashScreen_OnOpen.md">OnOpen</a></td>
<td>Called when splash scene is opened.<br />(Overrides <a href="M_AdvancedSceneManager_Loading_LoadingScreenBase_OnOpen.md">LoadingScreenBase.OnOpen()</a>)</td></tr>
<tr>
