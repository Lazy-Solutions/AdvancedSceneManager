...
Represents a persistent reference to the GameObject that this is attached to, see also <a href="T_AdvancedSceneManager_Utility_GuidReferenceUtility.md">GuidReferenceUtility</a> .
