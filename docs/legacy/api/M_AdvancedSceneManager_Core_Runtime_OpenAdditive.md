...
# OpenAdditive(SceneCollection, Boolean) Method
...
#### Parameters
<dl><dt>Â Â <a href="T_AdvancedSceneManager_Models_SceneCollection.md">SceneCollection</a></dt><dd>The collection to open.</dd><dt>Â Â <a href="https://learn.microsoft.com/dotnet/api/system.boolean" target="_blank" rel="noopener noreferrer">Boolean</a>Â Â (Optional)</dt><dd>Specifies whatever all scenes should open, regardless of open flag.</dd></dl>
