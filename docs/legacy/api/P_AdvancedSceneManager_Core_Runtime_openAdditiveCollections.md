# openAdditiveCollections Property
...
**C#**
``` C#
public IEnumerable<SceneCollection> openAdditiveCollections { get; }
```
...
#### Implements
<a href="P_AdvancedSceneManager_DependencyInjection_ISceneManager_openAdditiveCollections.md">ISceneManager.openAdditiveCollections</a>  
