...
# hasDefaultCallback Property


Gets whatever *T* has a default callback. All callbacks inheriting from <a href="T_AdvancedSceneManager_Callbacks_ISceneCallbacks.md">ISceneCallbacks</a> should have one.
