...
# FindCollections(Scene, Boolean) Method
...
#### Parameters
<dl><dt>Â Â <a href="T_AdvancedSceneManager_Models_Scene.md">Scene</a></dt><dd>Â </dd><dt>Â Â <a href="https://learn.microsoft.com/dotnet/api/system.boolean" target="_blank" rel="noopener noreferrer">Boolean</a>Â Â (Optional)</dt><dd>Â </dd></dl>
...
<a href="Overload_AdvancedSceneManager_Utility_SceneUtility_FindCollections.md">FindCollections Overload</a>  
