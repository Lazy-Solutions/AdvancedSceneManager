...
# OpenLoadingScreen(SceneOperation, Action&lt;LoadingScreen&gt;) Method
...
#### Parameters
<dl><dt>Â Â <a href="T_AdvancedSceneManager_Core_SceneOperation.md">SceneOperation</a></dt><dd>Â </dd><dt>Â Â <a href="https://learn.microsoft.com/dotnet/api/system.action-1" target="_blank" rel="noopener noreferrer">Action</a>(<a href="T_AdvancedSceneManager_Loading_LoadingScreen.md">LoadingScreen</a>)Â Â (Optional)</dt><dd>Â </dd></dl>
