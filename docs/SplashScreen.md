...
This will fade the splash screen in, wait for 4 seconds, and then fade out again, and then ASM will continue with [startup](../api/AdvancedSceneManager.Core.Runtime.html).
