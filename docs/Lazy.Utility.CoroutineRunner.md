...
```csharp
readonly Dictionary<GlobalCoroutine, Coroutine> m_coroutines = new Dictionary<[GlobalCoroutine](Lazy.Utility.GlobalCoroutine.md#Lazy.Utility.GlobalCoroutine), Coroutine>()
```
